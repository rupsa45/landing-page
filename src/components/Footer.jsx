...
const Footer = () => {
  return (
    <div className='w-full mt-24 bg-gradient-to-r from-gray-400 to-gray-600 text-gray-300 py-2 px-2'>
      ...
      <div className='flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500'>
        <p className='py-4 text-gray-900'>2023 Experiences, LLC. All rights reserved</p>
